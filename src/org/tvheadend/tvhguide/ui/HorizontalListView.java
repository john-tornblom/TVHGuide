package org.tvheadend.tvhguide.ui;
...
public class HorizontalListView extends AdapterView<ListAdapter> {
	...
	protected ContextMenuInfo getContextMenuInfo() {
		...
		return new AdapterView.AdapterContextMenuInfo(child, mLeftViewIndex + 1
				+ selectedIndex, mAdapter.getItemId(mLeftViewIndex + 1
				+ selectedIndex));
	}
