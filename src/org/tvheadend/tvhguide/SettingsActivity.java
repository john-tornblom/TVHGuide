...
public class SettingsActivity extends PreferenceActivity {
	...
	protected void onStart() {
		...
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(this);
		oldHostname = prefs.getString("serverHostPref", "mediaserver");
	...
	protected void onPause() {
		...
		reconnect |= oldPort != Integer.parseInt(prefs.getString(
				"serverPortPref", ""));
		...
		if (reconnect) {
			Log.d("SettingsActivity",
					"Connectivity settings chaned, forcing a reconnect");
			...
			intent.putExtra("port",
					Integer.parseInt(prefs.getString("serverPortPref", "")));
